...
## I. Development purpose
    ...
    5、Simple: all are bat scripts. You can modify and add your own knowledge of writing bat;
    6、blog  : https://blog.csdn.net/dbyoung/article/details/128879828?spm=1001.2014.3001.5501
...
## II. Instructions
    ...
    3、VCS does not download the source code. You need to download the source code yourself and put it in the "F:\source". Of course, you can modified in "vcs.cmd";
